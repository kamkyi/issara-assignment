...
const NavBar = (props) => {
    return (
        ...
        <Nav.Link><Image width="30px" src={props.flag}/></Nav.Link>
            ...
            <Nav className="mr-auto">
                <NavDropdown title="Choose Language" id="change-language-nav-dropdown">
                {
                    props.languages.map(language => {
                        return <NavDropdown.Item key={language.code} onClick={props.chosen.bind(this,language.code,language.flag)}> <Image width="30px" src={language.flag} thumbnail /> {language.name}</NavDropdown.Item>
                    })           
                }
            </NavDropdown>
            </Nav>
